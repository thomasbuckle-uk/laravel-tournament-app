    ...
    <form @submitted="updateProfileInformation">
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Team Profile</h3>
                ...
                <div class="grid grid-cols-3 gap-6">
                  ...
                  <span class="inline-block bg-gray-100 rounded-full overflow-hidden h-12 w-12">
                    ...
                    <div class="col-span-3">
                        ...
                        <p class="mt-2 text-sm text-gray-500">Used on your team profile page</p>
                    </div>
                </div>
            </div>
